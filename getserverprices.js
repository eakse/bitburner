...
const string_get_number_abbreviated = function (float_number) {
    ...
    return `${float_number_new.toFixed(0)}${string_suffixes[integer_index_suffix]
        }`;
};
...
const string_line = function (ns, integer_ram) {
    ...
    return `${integer_ram
        ...
        }${object_constants.string_separator_column}${integer_cost
            .toLocaleString()
...
const string_get_header = function (ns) {
    ...
    return `${(object_constants.string_column_title_1)
            .padEnd(integer_get_padding_column_1(ns))
        }${object_constants.string_separator_column}${(object_constants.string_column_title_2)
            .padEnd(integer_get_padding_column_2(ns))
